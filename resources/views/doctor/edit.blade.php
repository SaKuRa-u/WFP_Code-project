    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0 fw-bold">Edit Dokter</h3>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <span class="badge" style="background:#fff3cd;color:#856404;font-size:0.7rem;">
                                        Mode Edit
                                    </span>
                                </div>
                                    ...
                                    @foreach ($specializations as $spec)
                                        <div class="spec-item">
                                            <input type="checkbox" name="specializations[]" id="spec_{{ $spec->id }}"
                                                value="{{ $spec->id }}"
                                                {{ in_array($spec->id, old('specializations', $selectedIds)) ? 'checked' : '' }}>
